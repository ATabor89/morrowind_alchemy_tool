...
//         expected_effects
//             .sort_by(|effect_1, effect_2| effect_1.to_string().cmp(&effect_2.to_string()));
...
//         let mut expected_effects = vec![Effect::Chameleon];
//         expected_effects
//             .sort_by(|effect_1, effect_2| effect_1.to_string().cmp(&effect_2.to_string()));
...
//         let mut expected_effects = vec![Effect::Chameleon, Effect::CurePoison];
//         expected_effects
//             .sort_by(|effect_1, effect_2| effect_1.to_string().cmp(&effect_2.to_string()));
